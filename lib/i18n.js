...
(function () {
  var DICT = {
    ...
    'In the heart of the island, steps from the malecón and the ferry, Florita 39 is a small five-suite hotel with a character of its own: sage-green stucco, chukum details, a tropical garden and a rooftop pool to watch the sun go down. A home by the sea, made to stay a while.':
      'En el corazón de la isla, a unos pasos del malecón y del ferry, Florita 39 es un hotel pequeño de cinco suites con personalidad propia: estuco verde sage, detalles de chukum, jardín tropical y una azotea con alberca para ver caer el sol. Una casa frente al mar pensada para quedarse.',
    ...
    'The suites · Five models': 'Las suites · Cinco modelos', 'Find your own.': 'Encuentra la tuya.',
    ...
    'Five suites with private entrances, a rooftop pool and club, a tropical garden and a genuine care for the island and its environment. For those who seek the privacy of a boutique hotel and a truly memorable stay.':
      'Cinco suites con entrada privada, alberca y club de azotea, jardín tropical y un cuidado genuino por la isla y su entorno. Para quienes buscan la privacidad de un hotel boutique y una estancia memorable.',
  ...
  var lang = 'en';
  try { lang = localStorage.getItem('f39_lang') || 'en'; } catch (e) {}
