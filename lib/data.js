...
window.F39DATA = {
  ...
  restaurant: {
    ...
    highlights: [
      { icon: 'coffee', label: 'All-day coffee', note: 'Locally roasted' },
      { icon: 'utensils', label: 'Regional kitchen', note: 'Yucatán & Caribbean' },
      { icon: 'wine', label: 'Sunset drinks', note: 'On the rooftop' },
    ],
  },
